...
def calculate_mpf(value, method):
    if method == "Air":
        if value <= 2500:
            return 2.62
        else:
            calculated_mpf = value * 0.003464
    ...
    for i in range(num_codes):
        ...
        if hts_input:
            ...
            if not matched_hts.empty:
                ...
                mpf = calculate_mpf(line_value, transport_method)
